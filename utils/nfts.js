...
import { API_URL, CONTRACT_ADDRESS, PINATA_API_KEY, PINATA_SECRET_KEY, PRIV_KEY, PUB_KEY } from '../config.js';
import path from 'path';
import FormData from 'form-data';
import { scrappImage } from './webscrapp.js';
import { throws } from 'assert';

async function createImgInfo(prompt) {
...
export async function createNFT(name, description, prompt) {
    try {
